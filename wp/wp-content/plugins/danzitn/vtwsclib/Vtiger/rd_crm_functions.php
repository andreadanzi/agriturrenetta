...
function login_ws_client($vt_url,$vt_username, $vt_appkey) {
    $client = new Vtiger_WSClient($vt_url);
    $checkLogin  = $client->doLogin($vt_username, $vt_appkey);
    return array("success"=>$checkLogin,"result"=>$client);
}
